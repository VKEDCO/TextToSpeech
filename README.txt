1) SimpleTTSDemo.rar is an Android application that takes typed strings
from the user and uses PICO to tts them.

2) TTSDonQuixote.rar is an android application that illustrates how
...
3) BhagavatGitaTTS.rar is an application that shows how the user 
